...
class ModuleObject extends MasterObject
{
	...
	{
		$pid = get('pid', 'int');
				$status = isset($_GET['status']) ? get('status', 'int') : TICK_STA_ANY;
	...
	{
		$pid = get('pid', 'int');
				$status = isset($_GET['status']) ? get('status', 'int') : ORD_PAID_ANY;
	...
	{
		$pid = get('pid', 'int');
				$status = isset($_GET['status']) ? get('status', 'int') : DELIV_SEND_No;
