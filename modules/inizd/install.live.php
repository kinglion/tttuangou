	...
	if (!$zzxgj)
	{
		$zzxgj_link_list = array(
			array (
				...
				'url' => 'http:/'.'/www.stzyhd.com',
			),
			array (
				'name' => _getaarrayrandval(array('志扬互动','开源微博系统','PHP微博程序','企业微博系统','企业微博程序',)),
				'url' => 'http:/'.'/stzyhd.com',
			),
			array (
				'name' => _getaarrayrandval(array('志扬互动系统','团购系统','php团购系统','团购程序','程序','志扬互动','团购网站程序','团购网站源码','团购源码','团购程序',)),
							'url' => 'http:/'.'/www.stzyhd.com',
			),
