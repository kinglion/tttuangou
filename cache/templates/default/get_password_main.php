...
<div class="t_area_in">
<div class="cur_title" ><?=$act_name?></div>
<? if('base'==$act) { ?>
<div class="t_area_in sect" >
<form method="POST"  action="index.php?mod=get_password&code=do_send">
<input type="hidden" name="FORMHASH" value='<?=FORMHASH?>'/>
<li>请输入您注册时填写的邮箱地址/登录Email</li>
<li><input dataType="LimitB" min="6" max="300" msg="请将长度控制在3~50个字符之间" name="to" type="text" class="p1" style="width:320px;" />&nbsp;<input type="submit" class="btn btn-primary" value="提  交" /></li>
</form>
<li><span>重设密码的邮件会发送到您的邮箱中，按其中的介绍操作即可重设密码</span></li>
</div><? } elseif('reset'==$act) { ?><div class="set_tag" ><span class="fontRed">*</span>为必填项</div>
