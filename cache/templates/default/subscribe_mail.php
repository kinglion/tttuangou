...
<div class="sect">
<p class="B2">邮件预定每日最新<?=TUANGOU_STR?>信息，了解<?=TUANGOU_STR?>第一手资讯。</p>
<div class="enter_address">
<p class="B2"><?=$this->Config['site_name']?>运行中，欢迎通过邮件订阅每日<?=TUANGOU_STR?>信息！</p>
...
<div class="mail">
<label>邮件地址：</label>
<input name="target" type="text" class="f_input f_mail input_h" id="email" size="20" value="<?=$target?>" />
...
&nbsp;&nbsp;
<input type="submit" value="订 阅" class="btn btn-primary">
</div>
</form>
</div>
</div>
