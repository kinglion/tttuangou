...
<div id="div_up_<?=$id?>" style="display: none;">广告图片：<input type="file" name="file_<?=$id?>" /> * 图片分辨率为 980 x 100</div>
...
图片切换方向：<label><input type="radio" name="data[dsp][switchPath]" value="top" 
<? if($cfg['dsp']['switchPath']=='top') { ?>
checked="checked"
<? } ?>
 />向上</label>&nbsp;&nbsp;<label><input type="radio" name="data[dsp][switchPath]" value="left" 
<? if($cfg['dsp']['switchPath']=='left') { ?>
checked="checked"
<? } ?>
 />向左</label><br/>
是否显示文字：<label><input type="radio" name="data[dsp][showText]" value="true" 
<? if($cfg['dsp']['showText']=='true') { ?>
checked="checked"
<? } ?>
 />是</label>&nbsp;&nbsp;<label><input type="radio" name="data[dsp][showText]" value="false" 
<? if($cfg['dsp']['showText']=='false') { ?>
checked="checked"
<? } ?>
 />否</label><br/>
是否显示按钮：<label><input type="radio" name="data[dsp][showButtons]" value="true" 
<? if($cfg['dsp']['showButtons']=='true') { ?>
checked="checked"
<? } ?>
 />是</label>&nbsp;&nbsp;<label><input type="radio" name="data[dsp][showButtons]" value="false" 
<? if($cfg['dsp']['showButtons']=='false') { ?>
checked="checked"
<? } ?>
 />否</label>
</td>
...
广告图片：<input type="file" name="file_<#ID#>" /> * 图片分辨率为 980 x 100<br/>\
