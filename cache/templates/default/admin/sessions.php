<? include handler('template')->file('@admin/header'); ?>
 <form action="admin.php" method="get" name="search"> <input type="hidden" name="mod" value="sessions" size="40"> <input type="hidden" name="code" value="search" size="40"> <table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder"> <tr class="header"> <td colspan="3"><span style="float:right">在线用户:<?=$total?>人</span> 搜索在线用户 </td> </tr> <tr> <td class="altbg1" width="30%"> 是否会员: </td> <td class="altbg2"> <?=$is_member_radio?> </td> <td rowspan="3" class="altbg1" width="200"><button name="do" value='' type="submit" class="button back2">搜索一下</button></td> </tr> <tr> <td class="altbg1" width="30%"> 用户名: </td> <td class="altbg2"><input type="text" name="username" value="<?=$username?>" size="40"> </td> </tr> <tr> <td class="altbg1" width="30%"> IP地址: </td> <td class="altbg2"><input type="text" name="ip" value="<?=$ip?>" size="40"> </td> </tr> </table> </form> 
<? if($session_list > 0) { ?>
 <table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder"> <form id='form1' name='form1' method="post"  action="<?=$action?>">
<input type="hidden" name="FORMHASH" value='<?=FORMHASH?>'/> <tr align="center" class="header"> <td>用户</td> <td>IP</td> <td>最后访问时间</td> </tr> 
<? if($order_html) { ?>
...
<? } ?>
 <table cellspacing="0" cellpadding="0" border="0" width="95%" align="center"> <tr> <td class="multi"></td> </tr> </table> <center> <button type="submit" class="button"> 提 交 </button> </center> </form> <br>
