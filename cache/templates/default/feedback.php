...
<div class="t_area_in">
<p class="cur_title">意见反馈</p>
<div class="sect">
<div class="nleftL">
欢迎您提供您的意见，有您的建议我们才有更大的进步空间！
<form action="?mod=list&code=dofeedback" method="post"  onsubmit="return check()">
...
<div id="l_act">
<input type="submit" class="btn btn-primary input_h"  value="提 交">
</div>
</form>
</div>
</div>
