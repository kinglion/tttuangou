		...
		$errer_msg="<html>
            ...
            <body>
                <div id=\"wrapper\">
                    <h1>发生如下错误:</h1>
						{$details}
					<div id=\"copyright\">Powered by <a href=\"http:/"."/www.tttuangou.net\" target=\"_blank\" title=\"[TTTuangou]志扬互动官方网站\" style=\"color: #666\"><b>TTTuangou</b> ".defined('SYS_VERSION') ? SYS_VERSION : ""."</a> &nbsp;&copy; 2005 - 2010 <a href=\"http:/"."/cenwor.com\"  title=\"志扬互动用户支持\" target=\"_blank\" style=\"color: #666\"><b> Cenwor Inc.</b></a></div>
                </div>
            </body>
		</html>";
		return $errer_msg;
