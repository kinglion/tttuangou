...
class bShareAPP
{
	...
	private function getLinks($uid=0,$pid=0)
	{
		...
		if ($bshare['ssc'])
		{
			$html .= '<div style="float:left;width:41px;background:transparent url(http://static.bshare.cn/frame/images/counter_box_18.gif) no-repeat;height:18px;margin:-10px 0 0 5px;text-align:center;font:bold 11px Arial,Helvetica,Tahoma,sans-serif;"><span class="BSHARE_COUNT" style="position:relative;line-height:18px;font-size:11px;top:0px;left:0px;color:rgb(51,51,51);float:none;"></span></div>';
		}
		echo $html;
	}
