...
$config['product']=array (
  ...
  'default_mailtype' => '1',
  'aboutme' => '<div class="" "\'""head""\'"""="" jquery1274230576000="" "\'""22""\'"""=""><h2>关于志扬互动</h2>
</div>
<div class="" "\'""sect""\'"""="" jquery1274230576000="" "\'""23""\'"""=""><p class="" "\'""caption""\'"""="">志扬互动网每天组织一次精品团购，为消费者发现最值得信赖的商家，让消费者享受超低折扣的优质服务。<br />
每天一单团购，为商家找到最合适的消费者，给商家提供最大收益的互联网推广。</p>
<dl><dt>如果您是消费者： </dt><dd><ul class="" "\'""list""\'"""=""><li>志扬互动每天帮您推荐一种优质的本地生活服务； </li>
<li>志扬互动的推荐一定物超所值； </li>
<li>志扬互动同时致力于帮您发现最好玩，最新鲜的生活方式； </li>
</ul>
</dd><dt>如果您是商家： </dt><dd><ul class="" "\'""list""\'"""=""><li>志扬互动有热爱尝试的消费者； </li>
<li>志扬互动有保证效果的广告价值； </li>
<li>志扬互动是您到达消费者的桥梁；</li>
</ul>
</dd></dl></div>',
  'privacy' => '<h4>隐私政策</h4>
<p>志扬互动非常重视对用户隐私权的保护，用户的邮件及手机号等个人资料为用户重要隐私，志扬互动网承诺不会将个人资料用作它途；承诺不会在未获得用户许可的情况下擅自将用户的个人资料信息出租或出售给任何第三方，但以下情况除外：</p>
...
<h4>使用说明</h4>
<p>志扬互动用户可以通过设定的密码来保护账户和资料安全。用户应当对其密码的保密负全部责任。请不要和他人分享此信息。如果您使用的是公共电脑，请在离开电脑时退出志扬互动以保证您的信息不被后来的使用者获取。</p>',
  'contat' => '我们的联系电话是：#￥@#￥@#￥@#￥@#￥<br />
地址是：@#￥@￥DEREWR',
...
<div class="" "\'""sect""\'"""="" sizcache="" "\'""5""\'"""="" sizset="" "\'""16""\'"""="" jquery1274230028234="" "\'""23""\'"""=""><h4>一、志扬互动服务条款的确认和接纳</h4>
<h4></h4>
<p>志扬互动网（以下简称本站）的各项电子服务的所有权和运作权归本站。本站提供的服务将完全按照其发布的服务条款和操作规则严格执行。用户必须完全同意所有服务条款并完成注册程序，才能成为本站的正式用户。用户确认：本协议条款是处理双方权利义务的当然约定依据，除非违反国家强制性法律，否则始终有效。在下订单的同时，您也同时承认了您拥有购买这些产品的权利能力和行为能力，并且将您对您在订单中提供的所有信息的真实性负责。</p>
<h4>二、服务简介</h4>
